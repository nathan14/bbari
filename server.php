...
$app->post("/post-new", function () use ($app, $conn) {
    ...
    $conn->query("INSERT INTO posts (title , date, authorName ,authorId ,shortDesc ,content ,recepie ,recepieHowTo ,imgId, badge, estTime)
...
$app->put("/post-edit", function () use ($app, $conn) {
    ...
    $conn->query("UPDATE posts
                            SET title = '$title', date = '$date', authorName = '$authorName' ,authorId = '$authorId',
